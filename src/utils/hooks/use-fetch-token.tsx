    ...
    const fetchTokenByAddress = async (tokenAddress: string) => {
        ...
        try {
            ...
            const normalized = {
                ...
                logoUrl:
                    payload.metadata?.logo_url ||
                    payload.metadata?.logoUrl ||
                    "",
                ...
                marketdata: {
                    price:
                        ...
                        undefined,
                    volume:
                        payload.market_data?.volume ??
                        payload.marketdata?.volume ??
                        "0",
                    circulatingSupply:
                        payload.market_data?.circulating_supply ??
                        payload.marketdata?.circulatingSupply ??
                        "0",
                    circulating_supply:
                        payload.market_data?.circulating_supply ?? undefined,
                },
                ...
                metadata: {
                    ...
                    website:
                        ...
                        payload.metadata?.website_url ??
                        "",
                    communityLinks:
                        payload.metadata?.community_links ??
                        payload.metadata?.communityLinks ??
                        [],
                },
